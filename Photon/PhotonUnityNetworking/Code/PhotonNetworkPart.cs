...
#pragma warning restore 0414
        ...
        public static void Instantiate(string v, object p, Quaternion quaternion, object rotation)
        {
            throw new NotImplementedException();
        }

        public static void Instantiate(string v, Vector3 vector3, object eulerRotationrotation)
        {
            throw new NotImplementedException();
        }
    }
